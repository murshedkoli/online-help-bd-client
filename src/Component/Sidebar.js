            ...
            <section className="sidebar" id="sidebar-scroll">
                <ul className="sidebar-menu">
                    ...
                    <li className={`treeview ${neworder}`}>
                        <Link to="/neworder">
                            <a className="waves-effect waves-dark" >
                                <i className="icon-plus" /><span> Place Request</span>
                            </a>
                        </Link>
                    </li>
                    ...
                    <li className={`treeview ${recharge}`}>
                        <Link to="/update-recharge">
                            <a className="waves-effect waves-dark" >
                                {
                                    loggedInUser.isAdmin ? <div><i className="icon-list" /><span> Recharge Request</span></div> : <div><i className="icon-list" /><span> Recharge History</span></div>
                                }
                            </a>
                        </Link>
                    </li>
