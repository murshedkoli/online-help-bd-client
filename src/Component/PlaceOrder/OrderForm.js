...
const OrderForm = () => {
    ...
    const completeOrder = () => {
        const newOrder = {
            ...
            cost: orderCost,
            status: 'pending',
            orderAmmount: orderData.orderAmmount || null,
            trnxNumber: orderData.trnxNumber || null,
        ...
        submitOrder ? <h2>Your Order Submited Successfully</h2> : <form onSubmit={submitData}>
...

            {
                ...
                <div>
                    ...
                    <div className="form-group">
                        <label htmlFor="voterNumber" className="form-control-label">Transection Number</label>
                        <input onBlur={handleOnBlur} type="text" className="form-control" name="trnxNumber" placeholder="Transection Number" required />
                    </div>
                </div>
            }
